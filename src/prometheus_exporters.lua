...
function exporter.connection()
    ...
    for ind, result in ipairs(key.connection) do
...
function exporter.requests( )
    ...
    for ind, result in ipairs(key.requestsDetail) do
